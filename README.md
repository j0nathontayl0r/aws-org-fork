...
# Network architecture diagram
    ALB - Public Subnets
        |
        v
ECS Fargate (Hello World API) - Private Subnets
        |
        v
...
- Compute: ECS Fargate runs any containerised workloads
...
- Data: Aurora PostgreSQL, or Aurora Serverless V1/V2 with PSQL Engine
...
- The app returns: "Hello World, we are connected to SQL Server" when the SQL connection is successful.
